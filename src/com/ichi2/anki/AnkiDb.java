...
public class AnkiDb {
    ...
    public AnkiDb(String ankiFilename) {
        ...
        mDatabase.execSQL("CREATE TABLE IF NOT EXISTS Attachment (" + " _id LONG PRIMARY KEY, "
                + "_path TEXT)");
        if (mDatabase != null) {
	...
	public String getAttachmentPath(String query) {
		Cursor cursor = null;
		String path = null;
    ...
    public void saveAttachment(long _id,String path)
    {
    	try{
    	     this.getDatabase().execSQL("INSERT INTO Attachment(_id,_path) VALUES("+_id+",'"+path+"');");
    	}
